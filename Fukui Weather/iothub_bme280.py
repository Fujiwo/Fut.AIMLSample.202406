...
MSG_TXT = "{\"deviceId\": \"myIoTDeviceId\",\"pressure\": %.2f,\"temperature\": %.2f,\"humidity\": %.2f,\"score\": %.2f,\"type\": \"weather\"}"
    ...
    try:
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                pressure, temperature, humidity = bme280_custom_2.readData()
                msg_txt_formatted = MSG_TXT % (pressure, temperature, humidity, 1.0 if is_rainy else 0.0)
                ...
                print ( ("IoTHubClient.send_event_async accepted message [%d] for transmission to IoT Hub: " + msg_txt_formatted)  % message_counter )
