...
public abstract class AIChatModel
{
	...
	IList<ChatMessage> ChatMessages => [
        SystemChatMessage,
        .. Messages.Select(message => new ChatMessage(message.Owner.Equals("User") ? ChatRole.User : ChatRole.Assistant, message.Content))
    ];
	...
	public async Task Post(string UserMessage)
	{
		...
		var responseWithoutStream = await client.GetChatCompletionsAsync(modelName, chatCompletionsOptions);
